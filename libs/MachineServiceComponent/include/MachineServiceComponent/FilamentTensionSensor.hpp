...
{
/// @brief Class represents a filament tension sensor.
class FilamentTensionSensor : public service_component::IFilamentTensionSensor,
                              public FilamentTensionSensorService
{
public:
    /**
     * @brief Construct a new filament tension sensor object.
     *
     * @param messageBroker Message broker instance.
     * @param processContext Process context.
     * @param serviceLocator Service locator instance.
     */
    FilamentTensionSensor(message_broker::IMessageBroker& messageBroker,
