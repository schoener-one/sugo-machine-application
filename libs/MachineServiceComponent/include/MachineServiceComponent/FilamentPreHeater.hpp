...
{
/// @brief Class represents a filament pre heater.
class FilamentPreHeater : public service_component::IFilamentPreHeater, public HeaterService
{
public:
    /**
     * @brief Construct a new filament pre heater object.
     *
     * @param messageBroker Message broker instance.
     * @param processContext Process context.
     * @param serviceLocator Service locator instance.
     */
    FilamentPreHeater(message_broker::IMessageBroker& messageBroker,
