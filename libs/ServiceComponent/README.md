# Sugo Service Component Library
...
This library contains the service component classes. A service component represent a unique component of
the system which provides a special functionality. It handles different messages and convert them into
the appropriate components actions and events.
Additional this package contains the code generator to generator automatically components derived from
the system state and communication description in YAML.
