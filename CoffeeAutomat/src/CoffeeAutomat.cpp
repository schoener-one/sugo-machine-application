...
, CommandExecutionComponent<CoffeeAutomat::State, CoffeeAutomat::Event>(messageBroker)
{
	...
	registerReceiver(command::CoffeeAutomatSwitchOff,
...
void CoffeeAutomatImpl::switchOn(const CoffeeAutomat::Event& event, const CoffeeAutomat::State& state)
{
	(void) event;
	(void) state;
...
void CoffeeAutomatImpl::initialize(const CoffeeAutomat::Event& event, const CoffeeAutomat::State& state)
{
	(void) event;
	(void) state;
...
void CoffeeAutomatImpl::runSelfTest(const CoffeeAutomat::Event& event, const CoffeeAutomat::State& state)
{
	(void) event;
	(void) state;
...
void CoffeeAutomatImpl::finishSelfTest(const CoffeeAutomat::Event& event, const CoffeeAutomat::State& state)
{
	(void) event;
	(void) state;
...
void CoffeeAutomatImpl::handleError(const CoffeeAutomat::Event& event, const CoffeeAutomat::State& state)
{
	(void) event;
	(void) state;
